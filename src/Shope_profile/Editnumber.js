...
const Editnumber = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={[styles.text2, { marginTop: moderateScale(15), }]}>Garage Contact Number</Text>
            <View style={styles.input1}>
                <TextInput placeholder='9136566625 / 0755 235689' placeholderTextColor={'#000000'} inputMode='numeric' style={styles.textinput1} />
                <Image source={require('../Icons/Images/edit.png')} style={styles.img2} />
            </View>

            <Pressable style={styles.button} onPress={toggleModal}>
                <Text style={[styles.text1]}>SAVE NUMBER</Text>
