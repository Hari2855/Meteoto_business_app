        ...
        <ScrollView style={styles.container1} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.container2}>
                ...
                <View style={styles.container4}>
                    ...
                    <Text style={[styles.text2, { marginLeft: moderateScale(10), marginTop: moderateScale(5) }]}>Booking Time: <Text style={{ color: '#333333', fontWeight: '600' }}>11:00PM</Text></Text>
