            ...
            <View style={styles.container5}>
                ...
                <View style={styles.container6}>
                    <View style={{ height: verticalScale(192), width: moderateScale(16) }}>
                        ...
                        <View style={[styles.circle, { borderColor: '#FF3F00' }]}>
                            <View style={{ height: scale(8), width: scale(8), borderRadius: scale(5), backgroundColor: '#4bae4f', alignItems: 'center', justifyContent: 'center' }}>
                                <Image source={require('../Icons/Images/Cancel.png')} style={{ width: scale(8), height: scale(8) }} />
                            </View>
                        </View>
                    ...
                    <View style={{ flexDirection: 'column' }}>
                        ...
                        <Text style={[styles.text2, { color: '#FF3F00', marginLeft: moderateScale(25), marginTop: moderateScale(30) }]}>Cancelled</Text>
                    </View>
                </View>
            </View>
        </ScrollView>
