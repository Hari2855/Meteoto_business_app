        ...
        <ScrollView style={styles.container1} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.container2}>
                ...
                <View style={styles.container4}>
                    ...
                    <Text style={[styles.text2, { marginLeft: moderateScale(10), marginTop: moderateScale(5) }]}>Cancel Date: <Text style={{ color: '#333333', fontWeight: '600' }}>29/09/23</Text></Text>
