    ...
    return (
        <ScrollView style={styles.container1} showsVerticalScrollIndicator={false}>
            <View style={styles.header}>
                <Pressable style={{ right: moderateScale(50) }} onPress={() => navigation.navigate('Payment')}>
            ...
            <View style={styles.container2}>
                ...
                <View style={styles.container4}>
                    ...
                    <Text style={[styles.text2, { marginLeft: moderateScale(10), marginTop: moderateScale(5) }]}>Cancel Date: <Text style={{ color: '#333333', fontWeight: '600' }}>28/09/23</Text></Text>
                ...
                <View style={[styles.container4, { height: verticalScale(145), borderStyle: 'dashed', borderColor: '#333333' }]}>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={[styles.text3, { marginLeft: '43%' }]}>Total Part(s): 01</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ width: scale(69), height: scale(24), borderWidth: 1, borderColor: '#333333', alignItems: 'center', justifyContent: 'center', marginLeft: '50%' }}>
                            <Text style={[styles.text2, { color: '#333333' }]}>Part - 01</Text>
                        </View>
                    </View>
                </View>
            ...
            <View style={styles.container5}>
                ...
                <View style={styles.container6}>
                    <View style={{ height: verticalScale(192), width: moderateScale(16) }}>
                        ...
                        <View style={[styles.circle, { borderColor: '#2F80ED'}]}>
                            <Image source={require('../Icons/Images/Refresh.png')} style={{width: scale(8), height: scale(8)}}/>
                        </View>
                        <View style={[styles.line1, { backgroundColor: '#999999' }]}></View>
                    ...
                    <View style={{ flexDirection: 'column' }}>
                        ...
                        <Text style={[styles.text2, { color: '#2F80ED', marginLeft: moderateScale(25), marginTop: moderateScale(30) }]}>Returning</Text>
